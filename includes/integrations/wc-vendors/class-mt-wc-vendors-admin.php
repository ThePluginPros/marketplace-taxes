...
class MT_WC_Vendors_Admin {
    ...
    public function __construct() {
        ...
        add_action( 'mt_load_integration', array( $this, 'includes' ) );
    }
    ...
    public function includes() {
        require_once __DIR__ . '/class-mt-wc-vendors-admin-notices.php';
    }
    ...
    public function add_admin_menu_item() {
        add_submenu_page(
            ...
            __( 'Tax Settings', 'marketplace-taxes' ),
            __( 'Taxes', 'marketplace-taxes' ),
            'manage_product',
            'tax-settings',
    ...
    public function admin_save_settings() {
        if ( isset( $_REQUEST['mt_settings_save'] ) && check_admin_referer( 'save-tax-settings' ) ) {
            $this->form()->save( $_POST );

            MT()->admin->add_notice( 'settings-saved', 'success', __( 'Settings saved.', 'marketplace-taxes' ) );
        }
    }
