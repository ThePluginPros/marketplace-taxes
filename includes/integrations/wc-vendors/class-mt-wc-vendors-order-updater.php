...
/**
 * Class MT_WC_Vendors_Order_Updater
 *
 * Updates existing vendor sub orders in the background.
 */
class MT_WC_Vendors_Order_Updater extends WP_Background_Process {
    ...
    public function __construct() {
        ...
        $this->action = 'mt_wc_vendors_order_updater';
    ...
    protected function task( $order_id ) {
        ...
        do_action( 'mt_vendor_order_created', $order->get_id() );

        wc_get_logger()->info( sprintf( 'Updated sub order #%s', $order_id ), [ 'source' => 'mt_wcv_order_updates' ] );
    ...
    protected function complete() {
        ...
        wc_get_logger()->info( 'Sub order update complete.', [ 'source' => 'mt_wcv_order_updates' ] );

        update_option( 'mt_sub_orders_updated', true );
    }
